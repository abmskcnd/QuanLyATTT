...
public class QuanLyATTT {
     ...
     *
     */
    public QuanLyATTT(SecretKey key) throws Exception {
    ...
    public static void main(String args[]) {
        try {
            ...
            String password = "n17at017";
            DESKeySpec key = new DESKeySpec(password.getBytes());
            SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("DES");

            //Instantiate the encrypter/decrypter
            QuanLyATTT des = new QuanLyATTT(keyFactory.generateSecret(key));
//          
            File pFile = new File("Tự Truyền Vào");
